...
url = 'http://geoffchappell.com/studies/windows/win32/kernel32/history/names63.htm?tx=2,6,17;1,4,16&ts=0,159'
...
json.dump(api_set_list, open("kernel32_api_win8-1",'w'))
